...
def flip_coin():
    ...
    # returning the coin flip result #ADDED UNDERLINE BETWEEN COINS AND TOSS
    return coin_toss
...
def guess_coin_flip():
    ...
    # flip the coin  # ADDED EQUALS SYMBOL BETWEEN COIN_FLIP AND  FLIP_COIN
    coin_flip = flip_coin() 
    
    # if the users guess is correct #ADDED EQUAL EQUAL FOR COMPARING AND CORRECT USER_GUESS - EXTRA S
    ...
    # return True of False based on the result #ADDED UNDERLINE BETWEEN user and guess
...
def guess_two_coin_flips():
    ...
    while successful_guesses < 2:
        ...
        # if the guess matches the coin flip #ADDED + TO SUCESSFUL GUESSES
        if result == True:
            guess_number += 1
